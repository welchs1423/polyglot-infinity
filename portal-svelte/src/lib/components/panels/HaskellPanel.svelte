<script>
    ...
    let bsSigma = $state(0.2); // volatility
...
<section class="panel">
    ...
    <div class="param-grid">
        ...
        <div class="param-row">
            <label for="hs-sigma">연변동성 σ</label>
            <input
                id="hs-sigma"
                type="range"
                min="0.05"
        ...
        <div class="param-row">
            <label for="hs-mcn">MC Paths</label>
            <input
                id="hs-mcn"
                type="range"
                min="100"
