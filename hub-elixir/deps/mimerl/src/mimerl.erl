...
extensions(<<"heic">>) -> <<"image/heic">>;
extensions(<<"heics">>) -> <<"image/heic-sequence">>;
extensions(<<"heif">>) -> <<"image/heif">>;
extensions(<<"heifs">>) -> <<"image/heif-sequence">>;
...
extensions(<<"sqlite">>) -> <<"application/vnd.sqlite3">>;
extensions(<<"sqlite3">>) -> <<"application/vnd.sqlite3">>;
...
mimetypes(<<"application/vnd.sqlite3">>) -> [<<"sqlite">>,<<"sqlite3">>];
...
mimetypes(<<"image/heic-sequence">>) -> [<<"heics">>];
mimetypes(<<"image/heic">>) -> [<<"heic">>];
mimetypes(<<"image/heif-sequence">>) -> [<<"heifs">>];
